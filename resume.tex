...
\input{cv-sections/education_cv.tex}
\input{cv-sections/skills_cv.tex}
\input{cv-sections/publications.tex}
\input{cv-sections/working_experience_cv.tex}
\input{cv-sections/research_experience_cv.tex}
