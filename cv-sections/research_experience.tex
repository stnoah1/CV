...
\item {Redefined action localization problem as a sequence translation problem and design the Attention Architecture to improve the performance.}
\end{cvitems}
}
...
\item {Created a virtual world using the Robotic Operating System (ROS) and GAZEBO which simulates the interaction between mobile robots and IoT devices.}
\end{cvitems} 
}
