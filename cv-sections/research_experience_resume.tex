...
\begin{cvitems}
\item {Introduced a large-scale mechanical components benchmark for the classification and retrieval tasks named Mechanical Components Benchmark. (\textit{Relevant publication: [\textbf{C5}]})}
...
\item {Introduced the conditional transformation unit which is designed to learn the latent space transformations corresponding to specified target views. (\textit{Relevant publication: [\textbf{J3}]})}
\end{cvitems}
}
