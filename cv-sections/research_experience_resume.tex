...
{Hand motion predction with RGBD-T data} % Organization
{C-design LAB, Purdue Univ.} % Location
{Jul. 2019 - Present} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
\item {Proposed a dataset by calibrating and mapping RGB, depth and thermal data for action recognition.}
...
\item {Introduced a part identifier module which learns part geometry to preserve part properties of 3D objects. (\textit{Relevant publication: [\textbf{J5}]})}
\end{cvitems}
}
