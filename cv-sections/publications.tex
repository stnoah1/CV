...
\begin{cvitems}
    ...
    \item {[\textbf{C10}] ``Multi-Modal Representation Learning with Tactile Modality", \textbf{IROS}, 2024 (submitted).}
    \item {[\textbf{C9}] ``CARING-AI: Context-aware Augmented Reality INstruction through Generative Artificial Intelligence", \textbf{UIST}, 2024 (submitted).}
