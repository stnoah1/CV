...
\item {[\textbf{J1}][\href{https://docs.google.com/viewer?url=https://github.com/stnoah1/CV/raw/master/documents/Edison.pdf}{\color{teal}{\textbf{PDF}}}] JIN YONGZHU, \textbf{H. G. Chi} and Soo-Hong Lee. (2016). A Study on the Optimal Design of Pedestrian Robots Using Janssen Mechanism. \textit{Korean Journal of Computational Design and Engineering Journal}, 22(2), pp. 18-22.}
\end{cvitems}
}
\cvpub
{Patents}{
