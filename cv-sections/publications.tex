...
{ % Description(s)
\begin{cvitems}
\item {[\textbf{J4}][\href{https://docs.google.com/viewer?url=https://github.com/stnoah1/CV/raw/master/documents/cag19.pdf}{\color{teal}{\textbf{PDF}}}] S. Kim, \textbf{H. G. Chi} and Karthik Ramani. "Object synthesis by learning part geometry with multi-tasks" (2019) \textit{Computer-Aided Design}, submitted.}
