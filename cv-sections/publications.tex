...
\item {[\textbf{C3}] \textbf{H. Chi}, M. Ha, S. Chi, S. Lee, Q. Huang, and K. Ramani. InfoGCN: Representation Learning for Human Skeleton-based Action Recognition, In proceedings of \textit{Conference on Computer Vision and Pattern Recognition (CVPR)} . accepted, 2022.}
...
\item {[\textbf{P1}][\href{https://docs.google.com/viewer?url=https://github.com/stnoah1/CV/raw/master/documents/patent.pdf}{\color{teal}{\textbf{PDF}}}] \textbf{H. G. Chi}. Computer Input Automation System. KR Patent No. 10-1745330, issued 2017.}
\end{cvitems}
}
