...
{ % Description(s)
\begin{cvitems}
    % \item {[\textbf{C10}] S. Kim, S. Seo, \textbf{H. Chi}, K. Ramani, J. Kim, and S. Kim. Higher-order Relation Reasoning for Trajectory Prediction, \textit{Conference on Computer Vision and Pattern Recognition (\textbf{CVPR})}. (in preparation)}
...
\begin{cvitems}
    ...
    \item {[\textbf{J5}] A. Unmesh,  R. Jain, J. Shi, VK Chaitanya, \textbf{H. Chi}, S. Chidambaram, A. Quinn, and K. Ramani. Interacting Objects: A dataset of object-object interactions for richer dynamic scene representations. In \textit{IEEE Robotics and Automation Letters (\textbf{RA-L})}. (accepted)}
