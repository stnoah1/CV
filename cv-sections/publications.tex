...
{ % Description(s)
\begin{cvitems}
\item {[\textbf{C3}][\href{https://docs.google.com/viewer?url=https://github.com/stnoah1/CV/raw/master/documents/cng19.pdf}{\color{teal}{\textbf{PDF}}}] S. Kim, \textbf{H. G. Chi} and Karthik Ramani. "Object synthesis by learning part geometry with multi-tasks" (2019) \textit{Computers \& Graphics}, submitted.}
