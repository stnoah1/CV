...
{ % Description(s)
\begin{cvitems}
    \item {[\textbf{J4}] H. Lee, J. Lee, S. Kwon, K. Ramani, \textbf{H. Chi}, and D. Mun. 3D CAD Model Simplification for Mechanical Parts Using Generative Adversarial Networks. In \textit{Computer-Aided Design}, under revision.}
...
{ % Description(s)
\begin{cvitems}
    \item {[\textbf{C9}] W. Roh, S. Lee, \textbf{H. Chi}, S. Kim. Functional Hand Type Prior for 3D Hand Pose Estimation \& Action Recognition from Egocentric View Monocular Videos, \textit{British Machine Vision Conference (\textbf{BMVC})}, 2023. Submitted.}
